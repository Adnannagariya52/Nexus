...
import { EASE_OUT } from "@/lib/landing-hooks";
        ...
        <div className="flex items-center gap-5">
          {!user && (
            <button
              ...
              className="hidden text-[12.5px] text-white/60 transition-colors duration-300 hover:text-white sm:block"
            >
              Sign in
            </button>
          )}
