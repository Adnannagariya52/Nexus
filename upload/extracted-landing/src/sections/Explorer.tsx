...
import { EASE, useIsMobile, usePointer, usePrefersReducedMotion, useViewportSize } from "../lib/hooks";
import { ScaledStage, Screen, WindowChrome, type ScreenId } from "../components/NexusUI";
